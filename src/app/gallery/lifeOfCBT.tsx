...
const LifeOfCBT: React.FC = () => {
  return (
    <main>
      <header>
        <h3 className="title_4 text-dark_gray text-center p-6 sm:p-8 lg:p-10 gap-2">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2  p-2 screen-size">
        ...
        <article className="col-span-1 grid grid-rows-1 h-full">
          <figure className="relative row-span-1 border-b-1 border-r-1 border-primary">
            <Image
              src={lifeOfCBT01}
              alt="lifeOfCBT01"
        ...
        <article className="col-span-1 grid grid-rows-1 h-full">
          <figure className="relative row-span-1 border-b-1  border-primary">
            <Image
              src={lifeOfCBT03}
              alt="lifeOfCBT03"
              className="w-full h-full"
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 screen-size p-2">
        {/* Left Column with multiple images stacked */}
        <article className="col-span-1 grid grid-rows-1 h-full ">
          <figure className="relative row-span-1 border-y-1 border-r-1 border-primary">
            <Image
              src={lifeOfCBT06}
              alt="lifeOfCBT06"
              className="w-full h-full "
        ...
        {/* Right Column with two stacked images */}
        <article className="col-span-1 grid grid-rows-1  h-full ">
          <figure className="relative row-span-1 border-y-1  border-primary">
            <Image
              src={lifeOfCBT07}
              alt="lifeOfCBT07"
              className="w-full h-full "
